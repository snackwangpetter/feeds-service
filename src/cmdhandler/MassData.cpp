...
{
    auto setBinReq = std::reinterpret_pointer_cast2<SetBinaryReq>(req);
    ...
    resp = std::reinterpret_pointer_cast2<Resp>(setBinResp);
...
{
    auto getBinReq = std::reinterpret_pointer_cast2<GetBinaryReq>(req);
    ...
    resp = std::reinterpret_pointer_cast2<Resp>(getBinResp);
                          ...
                          std::shared_ptr<Resp> &resp)
{
    ...
    auto getBinResp = std::reinterpret_pointer_cast2<GetBinaryResp>(resp);
